## Intro
Up to date, post 0.3, ZMK firmware for the Eternal Keypad.
Enabling ZMK Studio and Underglow.
...
- [Keymap Layout Helper](https://nickcoutsos.github.io/keymap-layout-tools/) for converting current keymap to a Json layout
